...
const styles = StyleSheet.create({
  ...
  emptyText: { color: '#bbb', fontSize: 14, fontWeight: '600', fontFamily: appFont },
  ...
  catLogoText: { fontSize: 16, fontWeight: '900', color: PRIMARY, fontFamily: appFont },
  ...
  catBadgeLetter: { fontSize: 17, fontWeight: '800', fontFamily: appFont },
  catItemText: { fontSize: 13, fontWeight: '700', color: '#666', textAlign: 'center', lineHeight: 16, fontFamily: appFont },
  ...
  searchInput: { flex: 1, fontSize: 14, color: '#000', padding: 0, fontFamily: appFont },
  ...
  productName: { fontSize: 14, fontWeight: '700', color: '#111', lineHeight: 20, marginBottom: 6, fontFamily: appFont },
  productPrice: { fontSize: 16, fontWeight: '900', color: PRIMARY, fontFamily: appFont },
  ...
  orderTitle: { fontSize: 18, fontWeight: '800', color: '#fff', fontFamily: appFont },
  ...
  clearBtnText: { fontSize: 12, fontWeight: '700', color: '#ff6b6b', fontFamily: appFont },
  ...
  itemsHeaderText: { fontSize: 11, fontWeight: '700', color: '#666', textTransform: 'uppercase', fontFamily: appFont },
  ...
  orderItemQty: { fontSize: 13, fontWeight: '800', color: '#fff', minWidth: 14, textAlign: 'center', fontFamily: appFont },
  orderItemMid: { flex: 1 },
  orderItemNameRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 4 },
  orderItemName: { fontSize: 13, fontWeight: '600', color: '#fff', lineHeight: 18, flex: 1, fontFamily: appFont },
  orderItemPrice: { fontSize: 13, fontWeight: '800', color: PRIMARY, marginTop: 2, fontFamily: appFont },
  orderItemSub: { fontSize: 12, color: '#888', marginTop: 1, fontFamily: appFont },
  noteInput: { backgroundColor: DARK2, borderRadius: 8, padding: 8, fontSize: 13, color: '#fff', minHeight: 32, textAlignVertical: 'top', marginVertical: 8, fontFamily: appFont },
  ...
  payBtnText: { fontSize: 13, fontWeight: '700', color: '#888', fontFamily: appFont },
  payBtnTextActive: { color: '#fff' },
  totalsBox: { backgroundColor: DARK2, borderRadius: 10, padding: 10, marginBottom: 10 },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 2 },
  totalRowLabel: { fontSize: 13, color: '#aaa', fontFamily: appFont },
  totalRowVal: { fontSize: 13, fontWeight: '600', color: '#aaa', fontFamily: appFont },
  grandTotalLabel: { fontSize: 19, fontWeight: '800', color: '#ccc', fontFamily: appFont },
  grandTotalAmt: { fontSize: 19, fontWeight: '800', color: '#fff', fontFamily: appFont },
  ...
  discountBtnText: { fontSize: 12, fontWeight: '700', color: '#f59e0b', fontFamily: appFont },
  ...
  placeBtnText: { color: '#fff', fontSize: 14, fontWeight: '800', fontFamily: appFont },
  ...
  modalSubtitle: { fontSize: 14, color: PRIMARY, fontWeight: '700', marginTop: 2, fontFamily: appFont },
  ...
  discountTypeBtnText: { fontSize: 14, fontWeight: '700', color: '#555', fontFamily: appFont },
  discountTypeBtnTextActive: { color: '#fff' },
  discountInput: { borderWidth: 1, borderColor: '#e0e0e0', borderRadius: 10, padding: 12, fontSize: 16, color: '#111', marginBottom: 12, fontFamily: appFont },
  ...
  discountPreviewAmt: { fontSize: 20, fontWeight: '800', color: '#16a34a', fontFamily: appFont },
  discountPreviewTotal: { fontSize: 13, color: '#555', fontFamily: appFont },
  ...
  discountClearBtnText: { fontSize: 14, fontWeight: '700', color: '#e74c3c', fontFamily: appFont },
  discountApplyBtn: { flex: 1, padding: 12, borderRadius: 10, backgroundColor: PRIMARY, alignItems: 'center' },
  discountApplyBtnText: { fontSize: 14, fontWeight: '700', color: '#fff', fontFamily: appFont },
  ...
  addonSectionTitle: { fontSize: 12, fontWeight: '800', color: '#555', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 10, fontFamily: appFont },
  ...
  chipText: { fontSize: 13, color: '#333', fontWeight: '600', fontFamily: appFont },
  chipTextActive: { color: '#fff' },
  addToOrderBtn: { backgroundColor: PRIMARY, margin: 16, borderRadius: 12, padding: 14, alignItems: 'center' },
  addToOrderBtnText: { color: '#fff', fontSize: 15, fontWeight: '800', fontFamily: appFont },
  ...
  addonErrorText: { color: '#e74c3c', fontSize: 13, fontWeight: '700', flex: 1, fontFamily: appFont },
  ...
  presetBtnText: { fontSize: 13, fontWeight: '700', color: '#555', fontFamily: appFont },
  ...
  toastText: { color: '#fff', fontSize: 14, fontWeight: '700', flex: 1, fontFamily: appFont },
  ...
  tableSelectorText: { flex: 1, fontSize: 13, fontWeight: '700', color: '#aaa', fontFamily: appFont },
  ...
  tableTypeBtnText: { fontSize: 13, fontWeight: '700', color: '#666', fontFamily: appFont },
  ...
  tableCardNum: { fontSize: 20, fontWeight: '900', color: '#333', fontFamily: appFont },
  tableCardText: { fontSize: 11, fontWeight: '600', color: '#666', fontFamily: appFont },
});