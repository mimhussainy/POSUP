...
const styles = StyleSheet.create({
  ...
  emptyText: { color: '#999', fontSize: 13, fontWeight: '400', fontFamily: appFont },
  ...
  catLogoText: { fontSize: 15, fontWeight: '700', color: PRIMARY, fontFamily: appFont },
  ...
  searchWrap: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 50, paddingHorizontal: 14, gap: 8, borderWidth: 1, borderColor: '#e0e0e0', height: 44 },
  searchInput: { flex: 1, fontSize: 14, color: '#222', padding: 0, fontFamily: appFont },
  ...
  productCard: { backgroundColor: '#fff', borderRadius: 14, padding: 14, minHeight: 100, justifyContent: 'space-between', borderWidth: 1, borderColor: '#e8e8e8' },
  ...
  orderTitle: { fontSize: 16, fontWeight: '700', color: '#fff', fontFamily: appFont },
  ...
  clearBtnText: { fontSize: 12, fontWeight: '500', color: '#ff6b6b', fontFamily: appFont },
  emptyOrder: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: 8 },
  itemsList: { flex: 1 },
  itemsHeader: { flexDirection: 'row', paddingBottom: 6, borderBottomWidth: 1, borderBottomColor: '#2a2a45', marginBottom: 6 },
  itemsHeaderText: { fontSize: 10, fontWeight: '500', color: '#888', textTransform: 'uppercase', letterSpacing: 0.5, fontFamily: appFont },
  orderItem: { paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#26263f' },
  ...
  qtyMiniBtn: { width: 20, height: 20, borderRadius: 10, backgroundColor: '#3a3a55', justifyContent: 'center', alignItems: 'center' },
  orderItemQty: { fontSize: 13, fontWeight: '600', color: '#fff', minWidth: 14, textAlign: 'center', fontFamily: appFont },
  orderItemMid: { flex: 1 },
  orderItemNameRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 4 },
  orderItemName: { fontSize: 13, fontWeight: '500', color: '#f0f0f5', lineHeight: 18, flex: 1, fontFamily: appFont },
  orderItemPrice: { fontSize: 13, fontWeight: '600', color: PRIMARY, marginTop: 2, fontFamily: appFont },
  orderItemSub: { fontSize: 11, color: '#999', marginTop: 1, fontFamily: appFont },
  noteInput: { backgroundColor: DARK2, borderRadius: 8, padding: 8, fontSize: 13, color: '#e8e8ee', minHeight: 32, textAlignVertical: 'top', marginVertical: 8, fontFamily: appFont },
  ...
  payBtnText: { fontSize: 13, fontWeight: '500', color: '#aaa', fontFamily: appFont },
  ...
  totalRowLabel: { fontSize: 12, color: '#bbb', fontFamily: appFont },
  totalRowVal: { fontSize: 12, fontWeight: '500', color: '#bbb', fontFamily: appFont },
  grandTotalLabel: { fontSize: 17, fontWeight: '600', color: '#ddd', fontFamily: appFont },
  grandTotalAmt: { fontSize: 17, fontWeight: '700', color: '#fff', fontFamily: appFont },
  ...
  discountBtnText: { fontSize: 12, fontWeight: '500', color: '#f59e0b', fontFamily: appFont },
  ...
  placeBtnText: { color: '#fff', fontSize: 14, fontWeight: '600', fontFamily: appFont },
  ...
  modalSubtitle: { fontSize: 13, color: PRIMARY, fontWeight: '500', marginTop: 2, fontFamily: appFont },
  modalCloseBtn: { width: 30, height: 30, borderRadius: 15, backgroundColor: '#EFEFF2', justifyContent: 'center', alignItems: 'center' },
  ...
  discountTypeBtn: { flex: 1, padding: 10, borderRadius: 10, backgroundColor: '#EFEFF2', alignItems: 'center' },
  discountTypeBtnActive: { backgroundColor: PRIMARY },
  discountTypeBtnText: { fontSize: 13, fontWeight: '500', color: '#444', fontFamily: appFont },
  discountTypeBtnTextActive: { color: '#fff', fontWeight: '600' },
  discountInput: { borderWidth: 1, borderColor: '#d8d8d8', borderRadius: 10, padding: 12, fontSize: 16, color: '#111', marginBottom: 12, fontFamily: appFont },
  discountPreview: { backgroundColor: '#f0fdf4', borderRadius: 10, padding: 12, marginBottom: 12, gap: 3 },
  discountPreviewLabel: { fontSize: 12, color: '#555', fontFamily: appFont },
  discountPreviewAmt: { fontSize: 19, fontWeight: '700', color: '#16a34a', fontFamily: appFont },
  discountPreviewTotal: { fontSize: 13, color: '#444', fontFamily: appFont },
  ...
  discountClearBtnText: { fontSize: 13, fontWeight: '600', color: '#e74c3c', fontFamily: appFont },
  discountApplyBtn: { flex: 1, padding: 12, borderRadius: 10, backgroundColor: PRIMARY, alignItems: 'center' },
  discountApplyBtnText: { fontSize: 13, fontWeight: '600', color: '#fff', fontFamily: appFont },
  ...
  addonSectionTitle: { fontSize: 11, fontWeight: '600', color: '#666', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 10, fontFamily: appFont },
  chipsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  chip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1.5, borderColor: '#d8d8d8', backgroundColor: '#fafafa' },
  chipActive: { backgroundColor: PRIMARY, borderColor: PRIMARY },
  chipText: { fontSize: 13, color: '#333', fontWeight: '500', fontFamily: appFont },
  chipTextActive: { color: '#fff', fontWeight: '600' },
  addToOrderBtn: { backgroundColor: PRIMARY, margin: 16, borderRadius: 12, padding: 14, alignItems: 'center' },
  addToOrderBtnText: { color: '#fff', fontSize: 14, fontWeight: '600', fontFamily: appFont },
  ...
  addonErrorText: { color: '#e74c3c', fontSize: 13, fontWeight: '500', flex: 1, fontFamily: appFont },

  discountPresets: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 14 },
  presetBtn: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1.5, borderColor: '#d8d8d8', backgroundColor: '#fafafa' },
  presetBtnActive: { backgroundColor: PRIMARY, borderColor: PRIMARY },
  presetBtnText: { fontSize: 13, fontWeight: '500', color: '#444', fontFamily: appFont },
  ...
  toastText: { color: '#fff', fontSize: 13, fontWeight: '500', flex: 1, fontFamily: appFont },
  ...
  tableSelectorText: { flex: 1, fontSize: 13, fontWeight: '500', color: '#bbb', fontFamily: appFont },
  ...
  tableTypeBtnText: { fontSize: 13, fontWeight: '500', color: '#999', fontFamily: appFont },
  tableCard: { width: 70, height: 70, borderRadius: 10, backgroundColor: '#EFEFF2', alignItems: 'center', justifyContent: 'center', gap: 2 },
  tableCardActive: { backgroundColor: PRIMARY },
  tableCardNum: { fontSize: 19, fontWeight: '700', color: '#222', fontFamily: appFont },
  tableCardText: { fontSize: 11, fontWeight: '500', color: '#666', fontFamily: appFont },
});