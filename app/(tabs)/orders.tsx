...
const styles = StyleSheet.create({
  ...
  emptyText: { color: '#bbb', fontSize: 13, fontWeight: '400', fontFamily: appFont },
  ...
  searchInput: { flex: 1, fontSize: 14, color: '#333', padding: 0, fontFamily: appFont },
  ...
  itemsHeaderText: { fontSize: 10, fontWeight: '500', color: '#555', textTransform: 'uppercase', letterSpacing: 0.5, fontFamily: appFont },
  ...
  orderItemName: { fontSize: 13, fontWeight: '500', color: '#e8e8f0', lineHeight: 18, flex: 1, fontFamily: appFont },
  orderItemPrice: { fontSize: 13, fontWeight: '600', color: PRIMARY, marginTop: 2, fontFamily: appFont },
  orderItemSub: { fontSize: 11, color: '#666', marginTop: 1, fontFamily: appFont },
  noteInput: { backgroundColor: DARK2, borderRadius: 8, padding: 8, fontSize: 13, color: '#ccc', minHeight: 32, textAlignVertical: 'top', marginVertical: 8, fontFamily: appFont },
  ...
  payBtnText: { fontSize: 13, fontWeight: '500', color: '#777', fontFamily: appFont },
  ...
  totalRowLabel: { fontSize: 12, color: '#aaa', fontFamily: appFont },
  totalRowVal: { fontSize: 12, fontWeight: '500', color: '#aaa', fontFamily: appFont },
  grandTotalLabel: { fontSize: 17, fontWeight: '600', color: '#ccc', fontFamily: appFont },
  ...
  discountTypeBtnText: { fontSize: 13, fontWeight: '500', color: '#555', fontFamily: appFont },
  ...
  discountPreviewLabel: { fontSize: 12, color: '#666', fontFamily: appFont },
  ...
  addonSectionTitle: { fontSize: 11, fontWeight: '600', color: '#888', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 10, fontFamily: appFont },
  ...
  chipText: { fontSize: 13, color: '#444', fontWeight: '500', fontFamily: appFont },
  ...
  presetBtnText: { fontSize: 13, fontWeight: '500', color: '#555', fontFamily: appFont },
  ...
  tableSelectorText: { flex: 1, fontSize: 13, fontWeight: '500', color: '#aaa', fontFamily: appFont },
  ...
  tableTypeBtnText: { fontSize: 13, fontWeight: '500', color: '#777', fontFamily: appFont },
  ...
  tableCardNum: { fontSize: 19, fontWeight: '700', color: '#333', fontFamily: appFont },
  tableCardText: { fontSize: 11, fontWeight: '500', color: '#777', fontFamily: appFont },
});